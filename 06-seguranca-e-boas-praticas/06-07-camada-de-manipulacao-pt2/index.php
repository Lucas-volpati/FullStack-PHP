...
echo $message->error(str_title($string));

echo $message->error(str_limit_words($string, 10, "... <a href='#'>[leias mais]</a>"));

echo $message->error(str_limit_chars($string, 43, "... <a href='#'>[leias mais]</a>"));