...
$error = $message->success("Mensagem de sucesso!");
...
echo $message->info("Mensagem de sucesso!");
echo $message->success("Mensagem de sucesso!");
echo $message->warning("Mensagem de sucesso!");
echo $message->error("Mensagem de sucesso!");
...
echo $message->info($message->error("Mensagem de sucesso!")->json());
